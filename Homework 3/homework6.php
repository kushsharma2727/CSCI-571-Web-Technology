...
<html>
    ...
    ?>
            ...
            if(isset($_GET["submit"])) {
                ...
                echo "<tr><td>".$symbol."</td><td>".$name."</td><td>".$exchange."</td><td><a href=http://cs-server.usc.edu:26909/homework6.php?symbol=$symbol&CompanyName=$CompanyName>More Details</a></td></tr>";
                }
